                      ...
                      child: GradientButton(
                        ...
                        onPressed: () async {
                          ...
                          if (_formKey.currentState!.validate()) {
                            var resStatus =
                                await authService.emailVerification(verificationCode.text);
                            switch (resStatus) {
                              case 200:
                                Navigator.of(context).pushNamedAndRemoveUntil(
                                    'home', (Route<dynamic> route) => false,
